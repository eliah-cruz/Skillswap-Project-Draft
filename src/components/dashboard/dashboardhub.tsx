                    ...
                    <div className="relative z-10 flex-1">
                      ...
                      <div className="flex gap-5 mb-2 pr-20">
                          ...
                          <div className="min-w-0 flex-1 pt-1 text-left">
                              ...
                              {/* TAGS ROW (FIXED SPACING: Changed gap-1.5 to gap-x-2 gap-y-2.5) */}
                      ...
                      {/* Bio Quote (FIXED SPACING: Added mt-6 mb-6 for breathing room) */}
                      <div className="mt-6 mb-6 px-2 border-l-[3px] border-slate-200">
                        <p className="text-[13px] text-slate-500 italic leading-relaxed line-clamp-2 pl-3">"{bioSnippet}"</p>
                      </div>

                      {/* Skill Boxes (FIXED SPACING: Changed space-y-3 to space-y-4) */}
