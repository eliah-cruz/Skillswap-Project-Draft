...
import { 
  ...
  MapPin, Flag, Repeat, GraduationCap, Coins, Briefcase, Utensils, Zap, Lock, ChevronRight
} from 'lucide-react';
            ...
            <div className="bg-slate-900 p-5 xs:p-6 sm:p-8 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl shadow-slate-200/50 text-white relative overflow-hidden border border-slate-800">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 md:mb-8 border-b border-slate-800 pb-4">
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto justify-start sm:justify-end">
                    ...
                    {/* Active Monitored My Own Star Rating Badge */}
                    <div className={`flex items-center gap-1 px-2.5 py-1.5 sm:py-1 rounded-lg sm:rounded-xl border shadow-sm cursor-default shrink-0 ${isMyRatingLow ? 'bg-red-950 text-red-500 border-red-800 animate-pulse' : 'bg-slate-800 text-amber-400 border-slate-700'}`}>
                      {isMyRatingLow ? <AlertTriangle size={12} className="shrink-0" /> : <Star size={12} className="fill-amber-400 shrink-0" />}
