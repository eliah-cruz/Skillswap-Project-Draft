...
// Helper to generate fake reviews
...
const baseMatches = [
  // Original Tech/Design/Language Users
  ...
  { id: 3, name: "Spammer Steve", teaching: "Marketing", needs: "Figma", rating: 2.5, avatar: "SS", status: "Online", category: "Marketing", title: "Growth Lead" }, // Will be soft deleted
  ...
  { id: 11, name: "Rude User", teaching: "Sales", needs: "UI/UX", rating: 3.1, avatar: "RU", status: "Offline", category: "Business", title: "Sales Director" }, // Will be soft deleted
  
  // New Culinary & Life Skills Users
